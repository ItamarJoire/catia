...
export function CardContainer({ title, description, portion, value, inCash, link, highlight, highlight2}){
  return(
    <div>
      ...
      <div className="mt-8 space-y-3">
        ...
        <h2 className="font-semibold text-xl md:text-2xl">{title} <span className='text-red-700'>Ebook grátis</span>)</h2> 
      ...
      <div className="mt-4">
        ...
        <p className="text-red-700 font-medium text-sm ">{highlight}</p>
      </div>
