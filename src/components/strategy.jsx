  ...
  return(
    <GridContainer>
      <div className="my-20 md:flex md:justify-around">
        ...
        <div className="mt-8">
          <p className="text-sm uppercase font-medium text-gray-700">Como Cátia Oliveira pode te ajudar?</p>
          <h2><span className="text-base-green text-xl">Aplicar as estratégias corretas me ajudou a </span>...</h2>
          <p className="text-gray-500 text-base">Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptatum placeat blanditiis atque magni voluptatem. Similique, odio temporibus velit consectetur dolor minima veniam culpa repellat laborum! Nihil esse ea sequi rem.
          <br /><br />
