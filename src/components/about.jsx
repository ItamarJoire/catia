...
export function About(){
  return(
    <GridContainer>
      <div>
        <div>
          <p className="text-sm uppercase font-light text-gray-700">Conheça um pouco da sua mentora</p>
          <h2><span className="text-base-green text-xl">Cátia Oliveira </span>...</h2>
          <p className="text-gray-500">Renomada empresária, escritora e palestrante, emerge como uma voz inspiradora para mulheres maduras que enfrentam desafios emocionais. Com 50 anos, mãe solo e cristã dedicada, Cátia é uma especialista em Gestão Empresarial e Master Coach, desempenhando o papel de mentora para mulheres que buscam superações significativas.
          <br /><br />
