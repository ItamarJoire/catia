      ...
      <GridContainer>
        <div className='md:flex md:items-center md:justify-around'>
          ...
          <div className='mb-16 flex flex-col '>
            <h1 className="font-['Poppins'] pt-10 text-4xl text-center font-semibold text-gray-800 max-auto md:text-left md:max-w-[420px]">
            ...
            <a href="#" className='font-["Poppins"] px-8 py-5 max-w-[280px] mx-auto bg-gradient-to-r from-base-green to-base-yellow-dark text-white font-bold rounded-md hover:opacity-90 duration-200 md:mx-0'>
              Quero mudar de vida!
            </a>
          </div>
